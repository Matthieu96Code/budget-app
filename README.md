...
- **A login page.**
- **A registration page.**
- **A categories page with the total amount of all the transactions that belongs to that category.**
- **A operations page with the total amount for the category at the top**
...
- Clone the project to your directory by running
  - `git clone https://github.com/Matthieu96Code/budget-app.git`
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/budget-app/issues).
